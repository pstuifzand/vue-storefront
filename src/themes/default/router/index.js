...
const ManufacturerList = () => import(/* webpackChunkName: "vsf-manufacturer" */ 'src/modules/manufacturer/components/ManufacturerList')
...
let routes = [
  ...
  { name: 'manufacturer', path: '/manufacturers', component: ManufacturerList }
]
